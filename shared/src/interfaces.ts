...
export type ReportedBooking = {
    //maxNrOfLessonsRestriction: number
    prupose:CourseDetails //only teacher
...
// non essential: chat teacher-> schemaCtrl'er
//slug.1 link to resourses
//slug.2 export schema
//slug.2 integrate w canvas