...
import {Landing,FeatureHome, ConsernedUserSetting,RoleTaskOnboarding, UserJourneyLayout,AddUserSettings} from '@/pages/useJourney'
import {ViewBookings,TransactionLayout,Checkout,Bookings} from '@/pages/Transaction'

import { clientLoader as featureLoader } from '@/pages/shared/DashboardLayout'
import { clientLoader as landingLoader } from '@/pages/useJourney/Landing'
...
import { clientLoader as staticRoomLoader } from './pages/useJourney/FeatureHome'
 ...
 * onboarding: 3 pages to inform and set user and set of users that is of interesst in the room // the layout displayed has different children on every page, there are no sections beside the main hero
...
const onboardingPrefix =  {
          ...
          const transactionPrefix = {path: JOURNY_LINSK_CONSTANTS.TRANSACTION_STEP1,
...
],{future:{   v7_relativeSplatPath: true, v7_startTransition: true, v7_fetcherPersist: true, v7_normalizeFormMethod: true,}})
