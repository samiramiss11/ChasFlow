...
export const clientAction = (store:ReduxStore): ActionFunction  => async({request}): Promise<Response | null>=>{
    ...
    <RoundedHeroWrapper>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col">
            ...
            <Input id="konsult" name="name" type="text" />
          </div>
          ...
          <div className="flex flex-col">
            ...
            <Input id="search2" name="password2" type="text" />
          </div>

          {/** Mejl */}
          <div className="flex flex-col">
            <Label htmlFor="mejl">Mejl</Label>
            <Input id="mejl" name="email" type="email" />
          </div>

          {/** Företag */}
          <div className="flex flex-col">
            <Label htmlFor="företag">Företag</Label>
            <Input id="företag" name="company" type="text" />
          </div>
        </div>
      </Form>
        </div>
